...
export const tools: Tool[] = [
  ...
  // ---------------------------------------------------------------- Phase 2
  {
    ...
    description:
      'Trace a PNG or JPG into a scalable SVG vector in your browser. Free, no upload, no watermark — your image never leaves your device.',
    h1: 'Convert an image to SVG',
    intro:
      'Turn a logo, icon, or graphic into a clean, scalable SVG. Toolpit traces your image into vector paths locally in your browser, so you get infinitely resizable artwork without uploading a single pixel.',
    keywords: ['png to svg', 'jpg to svg', 'image to vector', 'image tracer'],
