...
export const tools: Tool[] = [
  ...
  // ------------------------------------------------ Phase 5: PDF authoring
  {
    ...
    status: 'live',
    name: 'PDF editor',
    summary: 'Rewrite the real text, and add shapes and signatures.',
    title: 'Free PDF Editor — Edit Existing PDF Text Online | Toolpit',
    description:
      'Edit the text already in a PDF, and add boxes, highlights, images and signatures. Free, no signup, no watermark, and your document is never uploaded.',
    h1: 'Edit a PDF',
    intro:
      'Click a line of the document’s own text and rewrite it: Toolpit reads the page’s content stream, deletes the original glyphs and draws yours in their place at the same position, size and colour — so the result is still real, selectable text. On top of that you can highlight a paragraph, box a figure, drop in a logo, or sign where it says sign. Every other online editor asks you to upload the contract first; this one never does, because the whole editor is running in this tab.',
    keywords: [
      'pdf editor',
      'edit pdf online',
      'edit pdf text',
